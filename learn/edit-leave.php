...
<?php
    ...
    if($count[0]==0)
    {
        ...
        echo '<script>window.location.href = "http://localhost/learn/edit-leave-new1.php"</script>';
    }
    else 
    {
        session_start();
        $_SESSION['app_id']=$application_id;
        echo '<script>window.location.href = "http://localhost/learn/edit-leave-apply.php"</script>';
    }
